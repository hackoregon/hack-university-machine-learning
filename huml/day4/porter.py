...
Reimplementation of `Porter stemming algorithm <http://tartarus.org/~martin/PorterStemmer/>`_
in Python.
...
def stem(w):
    """Stemming function: uses the Porter stemming algorithm to remove suffixes from English words.
